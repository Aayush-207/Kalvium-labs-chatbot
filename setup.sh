...
echo "2. Start Backend: npm run dev (from backend/)"
echo "3. Start Worker: npm run worker:dev (from backend/ in new terminal)"
echo "4. Start Frontend: npm run dev (from frontend/ in new terminal)"
echo ""
